...
export class XucXac extends Component {
  ...
  render() {
    /*
Có 2 cách để action lên reducer chỉ được chọn 1 trong 2

+Sử dụng this.props.dispatch(lưu ý component connect với redux mới
  có props này)
        ...
        <div className="row text-center">
          <div className="col-4">
            <button className="btn btn-success">
              <div
                className="display-4 p-5 text-white bg-success"
                onClick={() => {
                  //Tạo ra action
                  const action = {
                    type: "DAT_CUOC",

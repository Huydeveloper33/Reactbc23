...
const mapStateToProps = (rootReducer) => {
  ...
  return {
    //Tạp ra các props cho component là  giá trị
    numberabc: rootReducer.stateNumber,
  };
};

//ĐỊnh nghĩa 1 hàm mapDispatchToProps ==> Tạo ra  các props cho component là hàm
